...
import { UInput, InputMask } from '../../components/Form';

import { Container, Content, BackButton, CreateButton, Form } from './styles';
      ...
      <Content>
        <header>
          ...
          <section>
            ...
            <CreateButton type="button" onClick={handleButtonSubmit}>
              <FiPlus size={24} />
              CADASTRAR
            </CreateButton>
          </section>
